...
let listado = ['Hola, quisiera recibir información de la institución', 'informacion', 'Información', 'información'];
...
.addAnswer(`
*Colegio Santa Lucia* 🏫
Estamos felices de poder darte la bienvenida a nuestro Institución. 🙂
...
O envianos un mensaje directo para responderte a la brevedad 📧 *soporte@gmail.com*
Estamos para ayudarte a resolver la consulta que tengas. 🙂
`)
.addAction((ctx, {endFlow}) => endFlow(`
En caso de ya encontrarse inscripto por favor envie el mensaje *Chatbot* para iniciar el sistema. 🤖
`))
